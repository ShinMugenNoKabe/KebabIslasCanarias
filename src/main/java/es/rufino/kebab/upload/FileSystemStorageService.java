...
public class FileSystemStorageService implements StorageService {
     ...
     * fichero a almacenar. Como lo asociamos al Empleado que se ha dado de
     * alta, usaremos el ID de empleado como nombre de fichero.
     *
     */
    @Override
    ...
    /**
     * Método que es capaz de cargar un fichero a partir de su nombre Devuelve
